...
var createCarRecord = function(make, model, year, license) {
  if(typeof make === 'undefined' || typeof model === 'undefined' || typeof year === 'undefined' || typeof license === 'undefined') {
    return 'new record must have make, model, year, and license values';
    console.log(make, model, year, license)

  } else if (typeof make != 'string' || typeof model != 'string' || typeof license != 'string') {
